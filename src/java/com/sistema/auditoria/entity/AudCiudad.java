 ...
 * @author 
 */
public class AudCiudad implements Serializable {
    ...
    public AudCiudad(BigDecimal ciuCodigo) {
        this.ciuCodigo = ciuCodigo;
    }

    public AudCiudad(BigDecimal ciuCodigo, String ciuNombre, Integer ciuEstado) {
        this.ciuCodigo = ciuCodigo;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AudCiudad)) {
            return false;
        }
        AudCiudad other = (AudCiudad) object;
    ...
    public String toString() {
        return "com.sistema.auditoria.entity.FacCiudad[ ciuCodigo=" + ciuCodigo + " ]";
    }
